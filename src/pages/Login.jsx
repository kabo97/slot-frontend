        ...
        <div className="flex bg-gray-900 text-white rounded-3xl shadow-2xl w-full max-w-5xl overflow-hidden">
            <div className="flex-[2] px-12 py-16 flex flex-col justify-center">
                ...
                <form onSubmit={handleSubmit} className="w-full">
                    ...
                    className="w-full mb-4 px-4 py-3 rounded-xl bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                    <button
                    type="submit"
                ...
                <p className="mt-6 text-sm text-gray-500 text-center">
                    Not a member? <span className="text-blue-400 hover:underline cursor-pointer">Sign up</span>
                </p>
            </div>
